...
namespace ISP {
    ...
    void ispUtils::multi(T* C, const T* A, const T* B) {
        ISP_ASSERT(NULL != C);
        ISP_ASSERT(NULL != B);
        ISP_ASSERT(NULL != A);
    ...
    void ispUtils::add(Tensor* C, const Tensor* A, const Tensor* B) {
        ISP_ASSERT(NULL != C);
        ISP_ASSERT(NULL != B);
        ISP_ASSERT(NULL != A);
    ...
    void ispUtils::dot(Tensor* C, const Tensor* A, const Tensor* B) {
        ISP_ASSERT(NULL != C);
        ISP_ASSERT(NULL != B);
        ISP_ASSERT(NULL != A);
        ISP_ASSERT(2 == C->dimensions());
    ...
    void ispUtils::invert(Tensor* dst, const Tensor* src) {
    ...
    void ispUtils::transpose(Tensor* dst, const Tensor* src) {
    ...
    void ispUtils::print(const Tensor* C, const char* head) {
        auto c = C->host<float>();
    ...
    void ispUtils::mulPerLine(Tensor* C, const Tensor* A, const Tensor* Line) {
        auto c = C->host<float>();
        auto a = A->host<float>();
    ...
    void ispUtils::divPerLine(Tensor* C, const Tensor* A, const Tensor* Line) {
        auto c = C->host<float>();
        auto a = A->host<float>();
        auto l = Line->host<float>();
        auto w = C->buffer().dim[1].extent;
    ...
    float ispUtils::matDet(const Tensor* A) {
